...
export const InteractiveKeybindings = () => {
  return (
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mt-10 p-6 rounded-lg bg-secondary/50 border border-terminal-border text-center">
          <p className="text-muted-foreground">
            ...
            +
            <kbd className.tsxclassName="px-2 py-1 text-xs bg-background rounded text-primary font-mono border border-terminal-border mx-1">
              K
            </kbd>{" "}
